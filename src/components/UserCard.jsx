  ...
  return (
    <article className='card'>
      ...
      <ul className='card__body'>
        ...
        <li className='card__item'><span className='card__span'>Birdthday</span>{user.birthday}</li>
      </ul>
      <footer className='card__footer'>
        <button className='card__btn card__btn__trash' onClick={() => deleteUserById(user.id)}><i className="fa-solid fa-trash"></i></button>
        <button className='card__btn card__btn__edit' onClick={handleEdit}><i className="fa-sharp fa-solid fa-pen-to-square"></i></button>
      </footer>
    </article>
  )
}
